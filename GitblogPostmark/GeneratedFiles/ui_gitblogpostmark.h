...
public:
    ...
    void setupUi(QMainWindow *GitblogPostmarkClass)
    {
        ...
        authorEdit->viewport()->setProperty("cursor", QVariant(QCursor(Qt::IBeamCursor)));
        ...
        tagsEdit->viewport()->setProperty("cursor", QVariant(QCursor(Qt::IBeamCursor)));
        ...
        summaryEdit->setFont(font);
        summaryEdit->viewport()->setProperty("cursor", QVariant(QCursor(Qt::IBeamCursor)));
        ...
        filePathBrowser->setGeometry(QRect(140, 30, 291, 41));
        filePathBrowser->viewport()->setProperty("cursor", QVariant(QCursor(Qt::IBeamCursor)));
        filePathBrowser->setAutoFillBackground(false);
        filePathBrowser->setTabChangesFocus(false);
        filePathBrowser->setUndoRedoEnabled(true);
    ...
    void retranslateUi(QMainWindow *GitblogPostmarkClass)
    {
        ...
        dateEdit->setDisplayFormat(QApplication::translate("GitblogPostmarkClass", "yyyy-MM-dd", 0));
